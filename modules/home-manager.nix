    ...
    { lib, config, ... }:
    {
      ...
      wayland.windowManager.hyprland.settings = {
        ...
        layerrule = [
          ...
          "animation none, match:namespace selection"
          "animation none, match:namespace overview"
          "animation none, match:namespace anyrun"
          "animation none, match:namespace popup.*"
          "animation none, match:namespace hyprpicker"
          "animation none, match:namespace notifications"
        ];
